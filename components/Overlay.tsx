    ...
    return (
        <Scroll html>
            <motion.div
                ...
                className="h-[90vh] sm:h-[100vh] w-[100vw] mb-[10vh] sm:mb-0 flex justify-center items-end md:items-center">
            ...
            <div
                id="model"
                className="h-[90vh] sm:h-[100vh] w-[100vw] mb-[10vh] sm:mb-0 flex justify-center p-8 md:p-[50px] lg:p-[100px]">
                <motion.div
            ...
            <div
                id="playground"
                className="h-[90vh] sm:h-[100vh] w-[100vw] mb-[10vh] sm:mb-0 flex items-start md:items-center p-8 lg:p-[100px] ">
