        ...
        <Scroll html style={{ height: "calc(100%*5)" }}>
            <div className="grid grid-rows-5 h-full">
                <motion.div
                    ...
                    className={`sm:mb-0 flex justify-center items-end md:items-center`}>
                ...
                <div
                    id="parcours"
                    className="flex flex-col items-start jsutify-start md:justify-center gap-6 md:p-4 lg:p-[100px]">
                    <motion.div
                        initial={{ opacity: 0 }}
                        whileInView={{ opacity: 1 }}
                        transition={{ duration: 0.3 }}
                        ...
                        <div className="flex flex-col gap-4 text-sm lg:text-lg">
                            <p>
                                I come from a fullstack web developer
                                background, I have graduated with a Tech Lead
                                Master in Paris in 2023 after 3 years of
                                internship in two different companies as a
                                fulltack Javascript Web developer.
                            </p>
                ...
                <div
                    id="model"
                    className="sm:mb-0 flex justify-center p-8 md:p-[50px] lg:p-[100px]">
                    <motion.div
                            ...
                            <div className="grid grid-rows-[repeat(3,auto)] gap-4">
                                <div>
                                    <p className="text-sm md:text-md">
                                        Giselle is the first 3D character I did.
                                        She has been created on Blender. She is
                                        inspired by me and my graphique style.
                                    </p>
                                </div>
                ...
                <div id="socials" className="flex md:items-center">
                    <motion.div
                ...
                <div
                    id="playground"
                    className="sm:mb-0 flex items-start md:items-center p-8 lg:p-[100px] ">
